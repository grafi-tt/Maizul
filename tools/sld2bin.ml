...
let print_bin i =
  print_char (char_of_int ((i lsr 24) land 255));
  print_char (char_of_int ((i lsr 16) land 255));
  print_char (char_of_int ((i lsr 8) land 255));
  print_char (char_of_int (i land 255))
